...
{
    public class GetTransactionsByDateTests : IClassFixture<FinTrackWebApplicationFactory<Program>>, IDisposable
    {
        ...
        public GetTransactionsByDateTests(FinTrackWebApplicationFactory<Program> factory)
        {
