...
{
    internal class GetTransactionByIdHandler : IRequestHandler<GetTransactionByIdQuery, ValueResult<Transaction>>
    {
        ...
        async public Task<ValueResult<Transaction>> Handle(GetTransactionByIdQuery request, CancellationToken cancellationToken)
        {
