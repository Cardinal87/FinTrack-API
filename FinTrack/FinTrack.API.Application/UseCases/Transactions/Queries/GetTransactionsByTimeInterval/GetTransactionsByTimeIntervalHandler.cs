...
namespace FinTrack.API.Application.UseCases.Transactions.Queries.GetTransactionsByTimeInterval
{
    class GetTransactionsByTimeIntervalHandler
        : IRequestHandler<GetTransactionsByTimeIntervalQuery, ValueResult<IReadOnlyCollection<Transaction>>>
    {
        ...
        async public Task<ValueResult<IReadOnlyCollection<Transaction>>> Handle(GetTransactionsByTimeIntervalQuery request, CancellationToken cancellationToken)
        {
