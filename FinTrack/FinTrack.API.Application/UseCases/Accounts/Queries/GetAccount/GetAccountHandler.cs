...
{
    internal class GetAccountHandler : IRequestHandler<GetAccountQuery, ValueResult<Account>>
    {
        ...
        async public Task<ValueResult<Account>> Handle(GetAccountQuery request, CancellationToken cancellationToken)
        {
